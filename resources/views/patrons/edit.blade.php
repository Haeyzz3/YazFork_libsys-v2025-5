    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <form action="{{ route('patrons.update', $patron) }}" method="POST">
            ...
            <div class="mt-6 flex items-center justify-between">
                <button type="button" class="text-sm font-semibold leading-6 text-red-900">Delete</button>
        ...
        <form id="delete-form" action="{{ route('patrons.destroy', $patron) }}" method="POST" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
    </div>
