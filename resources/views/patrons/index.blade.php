                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            @foreach($patrons as $patron)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $patron->patronDetails->patronType->name }}</td>
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 lg:pr-8">
                                        <a href="{{ route('admins.edit', $patron) }}" class="text-indigo-600 hover:text-indigo-900">View all details<span class="sr-only">, {{ $patron->first_name }}</span></a>
                                    </td>
                                </tr>
                            @endforeach
