    ...
    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex justify-end gap-2">
        <div class="flex gap-4 w-full sm:w-auto">
            ...
            <div class="flex-1 sm:flex-none">
                <input type="text" name="search" id="search" placeholder="Search by accession number..."
            ...
            <div class="inline-block min-w-full py-2 align-middle">
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Primary Author</th>
                    ...
                    @foreach($records as $record)
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $record->book->primary_author }}</td>
